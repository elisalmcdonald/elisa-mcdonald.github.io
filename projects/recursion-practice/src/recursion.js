...
var buildList = function(value, length, array = []) {
  ...
  buildList(value, length - 1, array)
  array.push(value)
  return array
};
...
var minimizeZeroes = function(array, array2 = []) {
  ...
  minimizeZeroes(array.slice(1), array2)
...
// alternateSign([-2,-7,8,3,-1,4]) // [2,-7,8,-3,1,-4]
var alternateSign = function(array, array2 = [], index = 0) {
  if (array.length === 0) {
    return array2
  }
  if (index % 2 === 0) {
  ...
  return alternateSign(array.slice(1), array2, index + 1);
};
