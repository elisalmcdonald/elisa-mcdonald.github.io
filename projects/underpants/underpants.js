...
_.each = function (collection, func) {
    ...
    if (Array.isArray(collection)) { // determine if it's truthy
        // iterate using for loop
        for (let i = 0; i < collection.length; i++) {
            // invoke function on current element, current index, and the collection itself
...
// result = func(accumlator, current, index, collection) 
...
_.extend = function(obj1, ...moreObjs) {
